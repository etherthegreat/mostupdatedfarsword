...
EVENTS = [
    ...
    ("Canada","Canadian Alliance","CAN_ALLIANCE_SIGNED",
     ...
     "FULL COMPLETION","can_alliance_signed_scene","Integrated","YES","explicit","0",
     "EXPLICIT #2 (all three); fires after can_summit_complete; form_alliance CA outcome. Text polished + art integrated. Intimate variant authored + art integrated. Explicit art (can_alliance_signed_explicit.png) pending final integration."),
    ...
    ("Canada","Canadian Alliance","CAN_ALLIANCE_SIGNED_INTIMATE",
     ...
     "FULL COMPLETION","can_alliance_signed_intimate","Integrated","NO","","0",
     "Intimate variant of CAN_ALLIANCE_SIGNED. Beach walk: philosophy of leadership, Marc launches into Québécois independence and visibly regrets his audience, they find the US/CA border marker and draw a heart (U+J+M) in the sand. Sun sets. Art: three-silhouette sunset scene."),
    ...
    ("Canada","Canadian Alliance","CAN_PEACE_01",
     ...
     "FIRST PASS","","Integrated","YES","explicit","0",
...
def add_legend_sheet(wb):
    ...
    cat_descs = {
        ...
        "CA Protector":   "Jessica Commanda Odjick's 8 creature arcs; Algonquin, Mi'kmaq, French-Canadian folklore",

...
LAWS = [
    ...
    ("USA", "Second Amendment", "Freedom",
     ...
     "2nd Amendment (1791)", "The right of the people to keep and bear arms shall not be infringed. Citizen militias stand ready to defend the Republic against all tyranny.",
     "FIRST DRAFT"),

    ("USA", "Merchant Marine Act", "Order",
     "−2 Mandate/Workshop · +2 Gold/Workshop · +1 Gold/Farm · +1 Gold/Camp",
     "Merchant Marine Act (1920)", "American vessels carry American goods. A strong merchant fleet drives exports and fills the treasury.",
     "FIRST DRAFT"),

    ("USA", "Municipal Reform Act", "Freedom",
     "−3 Mandate/Courthouse · +1 Happiness/Farm · +1 Happiness/Camp",
     "Municipal reform tradition (1800s–1900s)", "Free and fair elections in every township. No appointed official may replace the voice of the people.",
     "FIRST DRAFT"),

    ("USA", "Voting Rights Act", "Freedom",
     "−1 Mandate/Province · +1 Max Level Courthouse",
     "Voting Rights Act (1965)", "No citizen shall be denied the right to vote on account of race or condition of previous servitude. The ballot is the foundation of a free Republic.",
     "FIRST DRAFT"),

    ("USA", "Civil Rights Act", "Equality",
     "−1 Mandate/Population · +1 Happiness/Population",
     "Civil Rights Act (1964)", "Discrimination based on race, color, or creed is abolished. All citizens stand equal before the law of this Republic.",
     "FIRST DRAFT"),

    ("USA", "Americans with Disabilities Act", "Equality",
     "+1 Gold/Workshop · −10% Population Upgrade cost",
     "Americans with Disabilities Act (1990)", "No citizen shall be excluded from civic life on account of disability. The Republic provides for all who cannot provide for themselves.",
     "FIRST DRAFT"),

    ("USA", "National Security Act", "Order",
     "−1 Mandate/Barracks · +5 Manpower/all buildings",
     "National Security Act (1947)", "A unified national defense apparatus ensures no enemy, foreign or domestic, can catch the Republic unprepared.",
     "FIRST DRAFT"),

    # ── CA ───────────────────────────────────────────────────────────────────
    ("CA", "Militia Act", "Freedom",
     "+5 Weapons/Mansion lvl · +25 MP/Farm · −1 Mandate/Farm · +1 Mandate/Forge",
     "Militia Act (1868)", "Every able-bodied man in the Dominion is liable for militia service. Our communities stand ready to defend the Crown's peace — and now the Republic's.",
     "FIRST DRAFT"),
...
DOCTRINES = [
    ...
    ("USA", "Tier 1", "National Monument Act",      "Antiquities Act",            "1906",
     "Monument: +1 Mandate",                                  "—",       "Providence", "FIRST DRAFT"),
    ...
    # ── CA Tier 1 ────────────────────────────────────────────────────────────
    ("CA", "Tier 1", "Canada Wildlife Act",              "Canada Wildlife Act",           "1973",
...
ICONS = [
    ...
    ("USA", "Tier 2 – 1800s/Modern", "Martin Luther King Jr.","1929–1968",
     ...
     "—", "FIRST PASS",
     "Civil rights leader. Monument double-bonus plus courthouse mandate."),
...
CA_EVENTS = [
    ...
    ("Canadian Alliance", "CAN_CALL_01",       "THE REPUBLIC REACHES OUT TO CANADA",
     ...
     "FIRST PASS"),
    ("Canadian Alliance", "CAN_PENOIT_01",     "MARK PENOIT OF THE HABITANTS RECEIVES THE MESSAGE",

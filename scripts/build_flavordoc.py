...
CA_PM_ARC = [
    ...
    ("CA_PM_LEGACY", "MARC PENOIT'S FINAL ASSESSMENT — THE DEPUTY GOVERNOR WRITES HIS HISTORY",
     ...
     "FULL PASS"),
    ("CA_QUEBEC_SEPARATION_01", "QUEBEC HOLDS THE REFERENDUM — AND MARC PENOIT CANNOT STOP IT",
     ...
     "FIRST PASS"),
    ("CA_QUEBEC_UNIFIED_01", "QUEBEC HOLDS THE REFERENDUM — AND VOTES TO BUILD A REPUBLIC TOGETHER",

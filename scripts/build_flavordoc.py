...
ICONS = [
    ...
    ("USA", "Tier 1 – Founding", "Eliza Schuyler Hamilton", "1757–1854",
     "Market: +1 Mandate/lvl · Courthouse: −1 Moral Decay/turn",
     "—", "INTEGRATED",
     "She outlived Hamilton by 50 years; preserved his legacy and built orphanages. Commerce with conscience; justice that does not rot."),
    ...
    ("CA", "Tier 1 – Founding", "Agnes Macphail",             "1890–1954",
     "Courthouse: +1 Mandate/level · Library: +1 Culture/level · All buildings (not Dock/Barracks/Fortress): −10 Manpower flat · Farms/Camps/Mines/Forges/Granaries: +1 Culture flat · Libraries/Monuments/Courthouses/Markets/Resorts: +1 Science flat",
     "—", "FULL PASS",
...
BELIEF_MODS = [
    # ── American Icon Mods ───────────────────────────────────────────────────
    ("Spirit of the General", "Icon — George Washington",
...
CA_PM_ARC = [
    ...
    ("CA_PM_DOUBT", "PENOIT QUESTIONS THE MILITIA'S RESOLVE",
     ...
     "BTN1: Reassure · BTN2: Share doubt (deepens relationship)",
     "FIRST PASS"),
    ("CA_PM_LOYALTY_TEST", "FRENCH HABITANTS FEEL LEFT BEHIND",
     "Branch (req: ca_pm_met, French Habitants loyalty < 20)", "Adds law to constitution: French Language Rights OR French Cultural Identity Enshrined",
     "BTN1: Promise Dual Language Rights (law: +1 Culture/QB buildings, +10% Manpower/QB Barracks, −2 Mandate/QB Courthouse) · BTN2: Patronize Québécois Cultural Institutes (law: QB Resort +1 Culture/Gold/−1 Mandate +100 Manpower, +50% CA resort dev)",
     "FULL PASS"),
...
CA_EVENTS = [
    ...
    # ── USA Protectors ────────────────────────────────────────────────────────
    ("USA Protector — Mothman",         "PROT_01_SUMMON", "THE MOTHMAN OF POINT PLEASANT",
     "Root",     "Fires when WV tile contested; standard summon check",
     "Summon/tame/agreement chain; grants Federal Atmospheric Surveillance Act spell",
     "FIRST PASS"),
    ("USA Protector — Mothman",         "PROT_01_TAME",   "MOTHMAN REDIRECTS — CROWN EYES NOW WATCHED",
     "Branch",   "Req: prot_01_summoned flag + objective met",
     "→ PROT_01_AGREE; Mothman observes Crown movements",
     "FIRST PASS"),
    ("USA Protector — Mothman",         "PROT_01_AGREE",  "MOTHMAN FORMALLY ACKNOWLEDGED BY THE DMA",
     "Followup", "Req: prot_01_tame flag + objective met",
     "Protector ally secured; spell added to Presidential Registry",
     "FIRST PASS"),

    ("USA Protector — Jersey Devil",    "PROT_02_SUMMON", "THE PINE BARRENS ARE OFF-LIMITS",
     "Root",     "Fires when NJ tile contested; standard summon check",
     "Summon/tame/agreement chain; grants Pine Barrens Development Moratorium spell",
     "FIRST PASS"),
    ("USA Protector — Jersey Devil",    "PROT_02_TAME",   "JERSEY DEVIL REDIRECTS TERRITORIAL AGGRESSION",
     "Branch",   "Req: prot_02_summoned flag + objective met",
     "→ PROT_02_AGREE",
     "FIRST PASS"),
    ("USA Protector — Jersey Devil",    "PROT_02_AGREE",  "THE PINE BARRENS ACCORD",
     "Followup", "Req: prot_02_tame flag + objective met",
     "Protector ally secured; spell added to Presidential Registry",
     "FIRST PASS"),

    ("USA Protector — Headless Horseman", "PROT_05_SUMMON", "THE HORSEMAN RIDES AGAIN",
     "Root",     "Fires when NY (Hudson Valley) tile contested; standard summon check",
     "Summon/tame/agreement chain; grants Classified Tactical Terror Budget spell",
     "FIRST PASS"),
    ("USA Protector — Headless Horseman", "PROT_05_TAME",   "HORSEMAN REDIRECTS — CROWN COURIERS TARGETED",
     "Branch",   "Req: prot_05_summoned flag + objective met",
     "→ PROT_05_AGREE",
     "FIRST PASS"),
    ("USA Protector — Headless Horseman", "PROT_05_AGREE",  "THE HORSEMAN COMMITS TO THE CONTINENTAL CAUSE",
     "Followup", "Req: prot_05_tame flag + objective met",
     "Protector ally secured; spell added to Presidential Registry",
     "FIRST PASS"),

    ("USA Protector — Goatman",         "PROT_06_SUMMON", "NO BILLY GOAT I'VE SEEN",
     "Root (DMA-gated)", "Fires when MD tiles 40/41/42 surveyed; consumes dmaInvestigationPending flag",
     "Objective 1: MD library+barracks targets met → TAME; grants Goatman's Judgement mil mod/spell",
     "FIRST PASS"),
    ("USA Protector — Goatman",         "PROT_06_TAME",   "GOATMAN: CONSEQUENCES",
     "Branch",   "Req: prot_06_summoned flag; MD lib+barracks objective met",
     "→ PROT_06_AGREE; Objective 2: MD total buildings ≥ 100",
     "FIRST PASS"),
    ("USA Protector — Goatman",         "PROT_06_AGREE",  "MIDNIGHT MEETING — THE TERMS OF THE DEAL",
     "Followup", "Req: prot_06_tame flag; MD buildings ≥ 100",
     "BTN1: agreement · BTN2 (explicit) → PROT_06_AGREE_INTIMATE; uses [CMD_POSSESSIVE] token",
     "FIRST PASS"),
    ("USA Protector — Goatman",         "PROT_06_AGREE_INTIMATE", "VOYEUR, NOT MONSTER",
     "Intimate",  "Req: BTN2 on PROT_06_AGREE",
     "Sets prot_06_agreed flag; Warm/Tender tone",
     "FIRST PASS"),

    ("USA Protector — Bell Witch",      "PROT_07_SUMMON", "THE BELL WITCH MANIFESTS IN TENNESSEE",
     "Root",     "Fires when Nashville (tile 165) owned; standard summon check",
     "Objective hint: TN culture+food ≥ 25 → TAME; grants Bell Witch's Gift spell (milmod: Giant Green Futa Dong +3 Atk/3 turns)",
     "FIRST PASS"),
    ("USA Protector — Bell Witch",      "PROT_07_TAME",   "THE HAUNTING OF BELL HOUSE",
     "Branch",   "Req: prot_07_summoned flag; TN culture+food ≥ 25",
     "→ PROT_07_AGREE; Objective 2: TN culture+food ≥ 40",
     "FIRST PASS"),
    ("USA Protector — Bell Witch",      "PROT_07_AGREE",  "JINGLE BELLS, KING GEORGE SMELLS",
     "Followup", "Req: prot_07_tame flag; TN culture+food ≥ 40",
     "BTN1: 'The meeting is enough' → prot_07_agreed · BTN2 (explicit) → PROT_07_AGREE_INTIMATE",
     "FIRST PASS"),
    ("USA Protector — Bell Witch",      "PROT_07_AGREE_INTIMATE", "BELL AND THE BEAST",
     "Intimate",  "Req: BTN2 on PROT_07_AGREE",
     "Sets prot_07_agreed flag; the velvet case; Warm/Tender tone",
     "FIRST PASS"),

    ("USA Protector — Old Ironsides",   "PROT_08_SUMMON", "OLD IRONSIDES SPOTTED ROVING THE COASTAL WATERS",
     "Root (DMA-gated)", "Fires when MA coastal tile investigated; consumes dmaInvestigationPending flag",
     "Summon/tame/agreement chain; grants Naval Superiority Maintenance Directive spell",
     "FIRST PASS"),
    ("USA Protector — Old Ironsides",   "PROT_08_TAME",   "PRESIDENT UALANI MEETS WITH OLD IRONSIDES",
     "Branch",   "Req: prot_08_summoned flag + objective met",
     "→ PROT_08_AGREE; two-hour meeting on USS Constitution",
     "FIRST PASS"),
    ("USA Protector — Old Ironsides",   "PROT_08_AGREE",  "PRESIDENT UALANI SETS SAIL",
     "Followup", "Req: prot_08_tame flag + objective met",
     "Protector ally secured; Constitution joins Continental Navy",
     "FIRST PASS"),

    ("USA Protector — Agent 355",       "PROT_16_SUMMON", "CULPER RING CONTACT ESTABLISHED — MANHATTAN ASSET ACTIVE",
     "Root (DMA-gated)", "Fires when Manhattan tiles 20/190/191 investigated; consumes dmaInvestigationPending",
     "Objective: playerSpyWins ≥ 3 → TAME; grants Culper Ring spell (enemy tile -5% shield/turn + reveal)",
     "FIRST PASS"),
    ("USA Protector — Agent 355",       "PROT_16_TAME",   "CULPER RING OPERATIONAL — CONTINENTAL INTELLIGENCE EXPANDS",
     "Branch",   "Req: prot_16_summoned flag; playerSpyWins ≥ 3",
     "→ PROT_16_AGREE; Objective 2: playerSpyWins ≥ 6",
     "FIRST PASS"),
    ("USA Protector — Agent 355",       "PROT_16_AGREE",  "AGENT 355 FORMALLY ACKNOWLEDGED — THE CULPER NETWORK IS YOURS",
     "Followup", "Req: prot_16_tame flag; playerSpyWins ≥ 6",
     "Protector ally secured; BTN2 (explicit) → PROT_16_AGREE_INTIMATE",
     "FIRST PASS"),

    ("USA Protector — Lincoln's Ghost", "PROT_17_SUMMON", "LINCOLN'S GHOST HAS BEEN SEEN IN THE WHITE HOUSE EAST WING",
     "Root (DMA-gated)", "Fires when DC tile investigated; consumes dmaInvestigationPending",
     "Summon/tame/agreement chain; grants Emancipation Proclamation 2 spell",
     "FIRST PASS"),
    ("USA Protector — Lincoln's Ghost", "PROT_17_TAME",   "LINCOLN'S GHOST ACKNOWLEDGES THE REPUBLIC",
     "Branch",   "Req: prot_17_summoned flag + objective met",
     "→ PROT_17_AGREE",
     "FIRST PASS"),
    ("USA Protector — Lincoln's Ghost", "PROT_17_AGREE",  "LINCOLN'S GHOST FORMALLY COMMITS TO THE CONTINENTAL CAUSE",
     "Followup", "Req: prot_17_tame flag + objective met",
     "Protector ally secured; BTN2 (explicit) → PROT_17_AGREE_INTIMATE",
     "FIRST PASS"),

    ("USA Protector — Wood Booger",     "PROT_03_SUMMON", "BIGFOOT SIDES WITH THE REVOLUTION",
     "Root",     "Fires when NC (Blue Ridge/Asheville) tile contested; standard summon check",
     "Summon/tame/agreement chain; grants Appalachian Privacy Protection Act spell",
     "FIRST PASS"),
    ("USA Protector — Wood Booger",     "PROT_03_TAME",   "APPALACHIAN PASSES REOPEN: BIGFOOT ACKNOWLEDGES THE REPUBLIC",
     "Branch",   "Req: prot_03_summoned flag + objective met",
     "→ PROT_03_AGREE; mountain passes opened",
     "FIRST PASS"),
    ("USA Protector — Wood Booger",     "PROT_03_AGREE",  "BIGFOOT FORMALLY GUIDES THE CONTINENTAL CAUSE THROUGH THE MOUNTAINS",
     "Followup", "Req: prot_03_tame flag + objective met",
     "Protector ally secured; BTN2 (explicit) → PROT_03_AGREE_INTIMATE",
     "FIRST PASS"),

    ("USA Protector — Pamola",          "PROT_04_SUMMON", "PAMOLA STIRS ABOVE KATAHDIN",
     "Root",     "Fires when ME (Bar Harbor/Acadia) tile contested; standard summon check",
     "Summon/tame/agreement chain; grants Executive Weather Control Initiative spell; school: storm",
     "FIRST PASS"),
    ("USA Protector — Pamola",          "PROT_04_TAME",   "PAMOLA WITHDRAWS — STORM ACTIVITY OVER ACADIA NORMALIZES",
     "Branch",   "Req: prot_04_summoned flag + objective met",
     "→ PROT_04_AGREE; Penobscot Nation liaison ceremony",
     "FIRST PASS"),
    ("USA Protector — Pamola",          "PROT_04_AGREE",  "PAMOLA FORMALLY ALIGNS WITH THE CONTINENTAL REPUBLIC",
     "Followup", "Req: prot_04_tame flag + objective met",
     "Protector ally secured; BTN2 (explicit) → PROT_04_AGREE_INTIMATE",
     "FIRST PASS"),

    ("USA Protector — Snallygaster",    "PROT_10_SUMMON", "THE SNALLYGASTER DESCENDS ON VIRGINIA",
     "Root",     "Fires when VA (Winchester/Shenandoah Valley) tile contested; DMA investigation required",
     "Summon/tame/agreement chain; grants Inter-Agency Cryptid Integration Program spell",
     "FIRST PASS"),
    ("USA Protector — Snallygaster",    "PROT_10_TAME",   "SNALLYGASTER REDIRECTS — CONTINENTAL SUPPLY ROUTES NOW CLEAR",
     "Branch",   "Req: prot_10_summoned flag + objective met",
     "→ PROT_10_AGREE; feeding station established in Shenandoah",
     "FIRST PASS"),
    ("USA Protector — Snallygaster",    "PROT_10_AGREE",  "SNALLYGASTER FORMALLY GUARDS THE CONTINENTAL SUPPLY NETWORK",
     "Followup", "Req: prot_10_tame flag + objective met",
     "Protector ally secured; BTN2 (explicit) → PROT_10_AGREE_INTIMATE",
     "FIRST PASS"),

    ("USA Protector — Black Dog",       "PROT_11_SUMMON", "THE BLACK DOG OF THE HANGING HILLS",
     "Root",     "Fires when CT (Hartford/Hanging Hills) tile contested; standard summon check",
     "Summon/tame/agreement chain; grants Black Dog Watch Protocol spell; school: cryptid",
     "FIRST PASS"),
    ("USA Protector — Black Dog",       "PROT_11_TAME",   "BLACK DOG REDIRECTED — CONTINENTAL PATROL ROUTES CLEARED",
     "Branch",   "Req: prot_11_summoned flag + objective met",
     "→ PROT_11_AGREE; omen redirected toward Crown forces",
     "FIRST PASS"),
    ("USA Protector — Black Dog",       "PROT_11_AGREE",  "BLACK DOG FORMALLY WATCHES THE HANGING HILLS FOR THE REPUBLIC",
     "Followup", "Req: prot_11_tame flag + objective met",
     "Protector ally secured; BTN2 (explicit) → PROT_11_AGREE_INTIMATE",
     "FIRST PASS"),

    ("USA Protector — Mercy Brown",     "PROT_12_SUMMON", "MERCY BROWN STIRS IN EXETER CHURCHYARD",
     "Root",     "Fires when RI (Coventry/Exeter) tile contested; standard summon check",
     "Summon/tame/agreement chain; grants Mercy Brown's Compact spell; school: spectral",
     "FIRST PASS"),
    ("USA Protector — Mercy Brown",     "PROT_12_TAME",   "MERCY BROWN WITHDRAWS FROM CONTINENTAL FORCES — RHODE ISLAND GARRISONS RECOVERING",
     "Branch",   "Req: prot_12_summoned flag + objective met",
     "→ PROT_12_AGREE; DMA cemetery visit establishes contact",
     "FIRST PASS"),
    ("USA Protector — Mercy Brown",     "PROT_12_AGREE",  "MERCY BROWN FORMALLY ALLIES WITH THE CONTINENTAL REPUBLIC",
     "Followup", "Req: prot_12_tame flag + objective met",
     "Protector ally secured; BTN2 (explicit) → PROT_12_AGREE_INTIMATE",
     "FIRST PASS"),

    ("USA Protector — Champ",           "PROT_13_SUMMON", "CHAMP SURFACES ON LAKE CHAMPLAIN",
     "Root",     "Fires when VT (Montpelier/Lake Champlain region) tile contested; standard summon check",
     "Summon/tame/agreement chain; grants Lake Champlain Sovereignty Decree spell; school: cryptid",
     "FIRST PASS"),
    ("USA Protector — Champ",           "PROT_13_TAME",   "CHAMP DISTINGUISHES CONTINENTAL VESSELS — LAKE CHAMPLAIN CROSSINGS RESTORED",
     "Branch",   "Req: prot_13_summoned flag + objective met",
     "→ PROT_13_AGREE; vessel white-stripe marking protocol",
     "FIRST PASS"),
    ("USA Protector — Champ",           "PROT_13_AGREE",  "CHAMP FORMALLY GUARDS LAKE CHAMPLAIN FOR THE REPUBLIC",
     "Followup", "Req: prot_13_tame flag + objective met",
     "Protector ally secured; BTN2 (explicit) → PROT_13_AGREE_INTIMATE",
     "FIRST PASS"),
]

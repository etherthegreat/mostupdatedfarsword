...
ARCHETYPES = [
    ...
    ("ARC_NA_01","Mohawk War Captain",      "WARRIOR",  "Woods / Foothills (NY/VT/PA)",
     "Woodsman",         "Guerrilla Tactics","Iron Bayonet",     "Last Stand",
     "Held the valley when everyone else fled. Still holding."),
    ("ARC_NA_02","Oneida Alliance Scout",  "SCOUT",    "Woods / Wetlands (NY/PA/VT)",
     "Woodsman",         "Quick Reload",     "Night Raider",     "Ghost March",
     "The Alliance fractured; their loyalty to the Republic did not."),
    ("ARC_NA_03","Wampanoag Mariner",      "ADMIRAL",  "Wetlands (MA/RI/CT)",
     "Coastal Watch",    "Marine",           "Swamp Legs",       "Naval Supremacy",
     "Sailed these waters before the Pilgrims could spell the word."),
    ("ARC_NA_04","Lenape Guide",           "FARMER",   "Farmlands (NY/PA/NJ)",
     "Steady Line",      "Farmhand",         "Rallying Voice",   "Continental Line",
     "Every road through the mid-Atlantic runs through their memory."),
    ("ARC_NA_05","Abenaki Tracker",        "SCOUT",    "Woods (ME/NH/VT/MA)",
     "Woodsman",         "Quick Reload",     "Guerrilla Tactics","Ghost March",
     "Three centuries of knowing which way the wind shifts."),
    ("ARC_NA_06","Cherokee Rifleman",      "SOLDIER",  "Foothills (NC/TN/GA/SC)",
     "Hill Runner",      "Marksman",         "Quick Reload",     "Ghost March",
     "Fought the British, fought the settlers, fought and fought and fought."),
    ("ARC_NA_07","Muscogee Creek Warrior", "WARRIOR",  "Wetlands (AL/GA/FL)",
     "Swamp Legs",       "Saber Drill",      "Guerrilla Tactics","Last Stand",
     "The swamp is a fortress only they can navigate."),
    ("ARC_NA_08","Shawnee Runner",         "SCOUT",    "Woods (OH/KY/WV/PA)",
     "Woodsman",         "Hill Runner",      "Night Raider",     "Ghost March",
     "No courier runs faster. No ambush comes quieter."),
    ("ARC_NA_09","Seneca War Chief",       "WARRIOR",  "Woods / Foothills (NY/PA)",
     "Woodsman",         "Saber Drill",      "Iron Bayonet",     "Entrenched",
     "Last guardian of the western door of the Haudenosaunee."),
    ("ARC_NA_10","Catawba Rifleman",       "SOLDIER",  "Foothills (NC/SC/VA)",
     "Hill Runner",      "Marksman",         "Steady Line",      "Continental Line",
     "Fought alongside Washington. Expects the debt to be remembered."),
    ...
    # ── NEW ENGLAND ───────────────────────────────────────────────────────────────
    ("ARC_26","Boston Irish Dockworker",   "SOLDIER",    "Metro (MA/NY/NJ)",
     "Street Tough",        "Quick Reload",     "Iron Bayonet",        "Last Stand",
     "Arrived on a coffin ship and stayed to fight"),
    ("ARC_27","Cape Ann Fisherwoman",      "SCOUT",      "Wetlands (MA/ME/NH/RI)",
     "Coastal Watch",       "Marksman",         "Marine",              "Naval Supremacy",
     "Has been reading weather, tide, and British patrol patterns since before the war"),
    ("ARC_28","Yankee Tinkerer",           "ENGINEER",   "Suburbs (MA/CT/RI/NH/VT)",
     "Fortified Position",  "Powder & Shot",    "Double Shot",         "Double Cannonade",
     "Has seventeen improvements to the army's equipment and they are all correct"),
    # ── MID-ATLANTIC ──────────────────────────────────────────────────────────────
    ("ARC_29","Tammany Ward Boss",         "DIPLOMAT",   "Metro (NY/NJ)",
     "Street Tough",        "Rallying Voice",   "Cleaner",             "Terror",
     "Controls six blocks, three polling stations, and knows where the barrels are buried"),
    ("ARC_30","Pennsylvania Dutch Braucher","HEALER",    "Farmlands (PA)",
     "Farmhand",            "Corrupted Ground", "Rallying Voice",      "Undaunted",
     "Speaks the Braucherei words over the wounded and they recover faster"),
    ("ARC_31","Hudson Valley Patroon",     "DIPLOMAT",   "Farmlands (NY/NJ)",
     "Fortified Position",  "Steady Line",      "Flanking Drill",      "Iron Wall",
     "Owns the land the tenants farm and the docks the merchants use"),
    # ── APPALACHIAN ───────────────────────────────────────────────────────────────
    ("ARC_32","Scots-Irish Rifleman",      "SOLDIER",    "Foothills (VA/WV/PA/NC/TN)",
     "Hill Runner",         "Marksman",         "Guerrilla Tactics",   "Ghost March",
     "Three generations in the backcountry; the long rifle is a family tradition"),
    ("ARC_33","Appalachian Moonshiner",    "SCOUT",      "Foothills (WV/VA/NC/TN/PA)",
     "Hill Runner",         "Woodsman",         "Night Raider",        "Ghost March",
     "Knows every hollow and exactly how much proof per gallon the excise men never found"),
    ("ARC_34","Granny Witch",              "MAGE",       "Foothills (WV/VA/NC/TN)",
     "Corrupted Ground",    "Farmhand",         "Rallying Voice",      "Undaunted",
     "Knows which plants heal, which words bind, and why the Crown's camps keep flooding"),
    # ── CHESAPEAKE / TIDEWATER ────────────────────────────────────────────────────
    ("ARC_35","Chesapeake Freedman Waterman","ADMIRAL",  "Wetlands (MD/VA/DE)",
     "Coastal Watch",       "Swamp Legs",       "Marine",              "Naval Supremacy",
     "Free Black waterman who knows the Chesapeake better than the Royal Navy"),
    ("ARC_36","Tidewater Gentlewoman",     "DIPLOMAT",   "Farmlands (VA/MD/NC)",
     "Steady Line",         "Rallying Voice",   "Cleaner",             "Continental Line",
     "Manages the estate, the correspondence network, and half the county's politics"),
    # ── GULLAH / AFRICAN AMERICAN ─────────────────────────────────────────────────
    ("ARC_37","Gullah Sea Islander",       "WARRIOR",    "Wetlands (SC/GA)",
     "Swamp Legs",          "Guerrilla Tactics","Night Raider",        "Liberator's Will",
     "The Sea Islands have their own language, their own calendar, their own war"),
    ("ARC_38","Underground Railroad Conductor","SPY",    "Farmlands (MD/PA/DE/VA/DC)",
     "Woodsman",            "Night Raider",     "Ghost March",         "The Long March",
     "Has moved hundreds of people north through territory the Crown claims to control"),
    ("ARC_39","Great Migration Church Elder","ORATOR",   "Metro (NY/PA/NJ/DC/MA)",
     "Street Tough",        "Rallying Voice",   "Cleaner",             "Continental Line",
     "Built the congregation the same way: no help, against opposition, with permanence"),
    # ── DEEP SOUTH ────────────────────────────────────────────────────────────────
    ("ARC_40","Deep South Sharecropper",   "FARMER",     "Farmlands (SC/GA/AL/NC)",
     "Farmhand",            "Steady Line",      "Flanking Drill",      "Last Stand",
     "Has been working this land under impossible terms longer than the war has existed"),
    ("ARC_41","Conjure Woman",             "MAGE",       "Wetlands (SC/GA/AL/FL/NC)",
     "Swamp Legs",          "Corrupted Ground", "Night Raider",        "Terror",
     "Hoodoo is older than the Republic and more reliable than its supply lines"),
    ("ARC_42","Florida Cracker Cowman",    "SCOUT",      "Farmlands (FL/GA)",
     "Farmhand",            "Hill Runner",      "Guerrilla Tactics",   "Ghost March",
     "Riding cattle across the scrub with a whip and a long rifle"),
    # ── INDUSTRIAL / URBAN ────────────────────────────────────────────────────────
    ("ARC_43","Rust Belt Union Organizer", "ORATOR",     "Suburbs (PA/NJ/NY)",
     "Street Tough",        "Rallying Voice",   "Flanking Drill",      "Liberator's Will",
     "Has organized three factories against Crown labor requisitions and will organize a fourth"),
    ("ARC_44","Little Italy Neighborhood Captain","SOLDIER","Metro (NY/NJ/PA)",
     "Street Tough",        "Steady Line",      "Iron Bayonet",        "Iron Wall",
     "The block association, the mutual aid network, and the militia are the same organization"),
    ("ARC_45","Lower East Side Organizer", "DIPLOMAT",   "Metro (NY/NJ/PA)",
     "Street Tough",        "Rallying Voice",   "Cleaner",             "Continental Line",
     "The garment workers and the radical press are already organized"),
    # ── CARIBBEAN / ATLANTIC ──────────────────────────────────────────────────────
    ("ARC_46","Bahamian Free Sailor",      "ADMIRAL",    "Wetlands (FL/BA/SC/GA)",
     "Coastal Watch",       "Swamp Legs",       "Marine",              "Naval Supremacy",
     "Runs the shallow-water routes the Royal Navy can't follow"),
    # ── WASHINGTON DC ─────────────────────────────────────────────────────────────
    ("ARC_47","DC Political Fixer",        "SPY",        "Metro (DC/MD/VA)",
     "Street Tough",        "Fortified Position","Cleaner",            "Terror",
     "Every leak, every loyalty question, every mandate crisis has a hand behind it"),
]

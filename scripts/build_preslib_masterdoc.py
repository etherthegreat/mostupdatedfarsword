...
RECORDS_DATA = [
    ...
    ("Game Systems","sys_factions","Factions","Regular",
     ...
     "",False,"FIRST PASS","",""),
    ("Game Systems","sys_reason_providence","Reason ↔ Providence","Regular",
     "The Reason ↔ Providence axis measures whether your republic leans toward civic rationalism (Icons) or formal religious doctrine (Doctrines). Tracked as churchLevel, −3 to +3.\n\nchurchLevel = (Doctrines purchased) − (Icons purchased), clamped to ±3.\n\nTemple output per level:\n  Providence III (+3): +1 Gold\n  Providence II (+2): +1 Gold, +1 Mandate\n  Providence I (+1): +1 Culture, +1 Gold, +1 Mandate\n  Balanced (0): +1 Culture, +1 Gold, +1 Mandate, +1 Happiness\n  Reason I (−1): +1 Culture, +1 Gold, +1 Happiness\n  Reason II (−2): +1 Culture, +1 Happiness\n  Reason III (−3): +1 Culture\n\nVisible in the Belief Panel. Purchase Doctrines to move toward Providence; purchase Icons to move toward Reason.",
     "",False,"FIRST PASS","","See also: bld_temple"),
    ...
    ("Buildings","bld_temple","Temple","Regular",
     "Produces Culture, Gold, Mandate, and Happiness depending on position on the Reason ↔ Providence axis. Reduces corruption. HEALER and CIRCUIT PREACHER governors amplify output. Required for religious law access. See sys_reason_providence for the full output table.",
     "",False,"FIRST PASS","","Governor: HEALER, CIRCUIT PREACHER | Mil Mod: Healer | American Icons: Phillis Wheatley, Sojourner Truth | See: sys_reason_providence"),
    ...
    # ── FAITHS & DOCTRINES ───────────────────────────────────────────────────
    ("Faiths & Doctrines","doc_healing_waters","Healing Waters","Regular",
     "Fresh water is scarce, and those who control it speak with the voice of the divine. Healing Waters doctrine channels spiritual energy through sacred springs and river sanctuaries.\n\nA Doctrine. Moves the republic one step toward Providence on the Reason ↔ Providence axis.",
     "",False,"FIRST PASS","","See: sys_reason_providence"),
    ("Faiths & Doctrines","doc_standing_stones","Standing Stones","Regular",
     "Monuments older than memory mark the sacred geography of the land. Standing Stones doctrine holds that the divine is written in stone and landscape — worship conducted not in buildings but at the sites where earth remembers.\n\nA Doctrine. Moves the republic one step toward Providence.",
     "",False,"FIRST PASS","","See: sys_reason_providence"),
    ("Faiths & Doctrines","doc_valued_idolatry","Valued Idolatry","Regular",
     ...
     "",False,"FIRST PASS","","See: sys_reason_providence"),
    ("Faiths & Doctrines","doc_sacred_groves","Sacred Groves","Regular",
     "The oldest temples are not buildings. Sacred Groves doctrine returns worship to the forest — to the places where light falls in columns and the wind carries messages the clergy cannot translate.\n\nA Doctrine. Moves the republic one step toward Providence.",
     "",False,"FIRST PASS","","See: sys_reason_providence"),
    ("Faiths & Doctrines","doc_midsummer_celebrations","Midsummer Celebrations","Regular",
     "When the year reaches its peak, the republic celebrates together. Midsummer Celebrations doctrine treats collective seasonal ritual as spiritual infrastructure — a people who believe together are harder to break apart.\n\nA Doctrine. Moves the republic one step toward Providence.",
     "",False,"FIRST PASS","","See: sys_reason_providence"),
    ("Faiths & Doctrines","doc_tree_of_life","Tree of Life","Regular",
     "The sacred tree stands at the center of the world. Tree of Life doctrine is the oldest theology in the catalogue — cosmological, pervasive, and remarkably durable. Every culture has a tree. This doctrine says the tree is real.\n\nA Doctrine. Moves the republic one step toward Providence.",
     "",False,"FIRST PASS","","See: sys_reason_providence"),
    ("Faiths & Doctrines","doc_tower_control","Tower Control","Regular",
     "Not all mystic practice is safe or sanctioned. Tower Control doctrine implements state oversight of spiritual energy — all arcane and religious activity channeled through licensed institutions. The scholars call it regulation.\n\nA Doctrine. Moves the republic one step toward Providence.",
     "",False,"FIRST PASS","","See: sys_reason_providence, bld_tower"),
    ("Faiths & Doctrines","doc_nature_sanctuaries","Nature Sanctuaries","Regular",
     "The divine is best approached through undisturbed wilderness. Nature Sanctuaries designates portions of territory as sacred preserves — off-limits to development, available to pilgrims, and deeply inconvenient to anyone who wanted to build a mine there.\n\nA Doctrine. Moves the republic one step toward Providence.",
     "",False,"FIRST PASS","","See: sys_reason_providence"),
    ("Faiths & Doctrines","doc_conservative_orthodoxy","Conservative Orthodoxy","Regular",
     "All divine revelation occurred at the moment of founding. Conservative Orthodoxy holds the church's role is preservation, not interpretation. No new prophets. No revised doctrine. What was written stands.\n\nA Doctrine. Moves the republic one step toward Providence.",
     "",False,"FIRST PASS","","See: sys_reason_providence"),
    ("Faiths & Doctrines","doc_sanctioned_cadaver_research","Sanctioned Cadaver Research","Regular",
     "Faith and medicine need not be enemies. Sanctioned Cadaver Research authorizes the church to permit the scientific study of the human body for medical advancement. It smells faintly of formaldehyde.\n\nA Doctrine. Moves the republic one step toward Providence.",
     "",False,"FIRST PASS","","See: sys_reason_providence"),
    ("Faiths & Doctrines","doc_temple_height_restrictions","Temple Height Restrictions","Regular",
     "No building may exceed the height of a temple in any settlement. A formal assertion that spiritual authority occupies more of the skyline than commerce or government.\n\nA Doctrine. Moves the republic one step toward Providence.",
     "",False,"FIRST PASS","","See: sys_reason_providence"),

    # ── AMERICAN ICONS ───────────────────────────────────────────────────────
    ("American Icons","icon_george_washington","George Washington","Regular",
     "The Father of the Nation — commander-in-chief who actually showed up, won, and then voluntarily left. Washington's patronage demands excellence from military and civic institutions alike.\n\nAn Icon. Moves the republic one step toward Reason on the Reason ↔ Providence axis.",
     "",True,"FIRST PASS","","See: sys_reason_providence, bld_barracks"),
    ("American Icons","icon_benjamin_franklin","Benjamin Franklin","Regular",
    ...
    ("American Icons","icon_abigail_adams","Abigail Adams","Regular",
     "She told John to 'remember the ladies' and he absolutely did not. Her patronage inspires dissent, scholarship, and the American art of telling power what it doesn't want to hear.\n\nAn Icon. Moves the republic one step toward Reason.",
     "",True,"FIRST PASS","","See: sys_reason_providence"),
    ("American Icons","icon_alexander_hamilton","Alexander Hamilton","Regular",
     "Built America's financial architecture through sheer will. Hamilton's patronage boosts Banks, Workshops, and every structure that converts ambition into revenue.\n\nAn Icon. Moves the republic one step toward Reason.",
     "",True,"FIRST PASS","","See: sys_reason_providence, bld_market"),
    ("American Icons","icon_phillis_wheatley","Phillis Wheatley","Regular",
     "The first enslaved African American to publish a book of poetry in the colonies — genius laughs at chains. Wheatley's patronage inspires Libraries and Temples wherever her memory is honored.\n\nAn Icon. Moves the republic one step toward Reason.",
     "",True,"FIRST PASS","","See: sys_reason_providence, bld_library, bld_temple"),
    ("American Icons","icon_thomas_jefferson","Thomas Jefferson","Regular",
     "Wrote that all men are created equal and then went home to his plantation. Libraries and Farms flourish under his patronage, but Harmony costs extra. History contains multitudes.\n\nAn Icon. Moves the republic one step toward Reason.",
     "",True,"FIRST PASS","","See: sys_reason_providence, bld_library, bld_farm"),
    ("American Icons","icon_abraham_lincoln","Abraham Lincoln","Regular",
     "The rail-splitter who held the Union together with sheer stubbornness. Lincoln's patronage represents sacrifice and reconstruction — the long, costly work of living up to founding documents.\n\nAn Icon. Moves the republic one step toward Reason.",
     "",True,"FIRST PASS","","See: sys_reason_providence"),
    ...
    ("American Icons","icon_sitting_bull","Sitting Bull","Regular",
     "Hunkpapa Lakota war chief, holy man, and the figure who outlasted Custer. His patronage honors the land itself — Nature Sanctuaries flourish and buildings in wooded and river territories produce bonus resources.\n\nAn Icon. Moves the republic one step toward Reason.",
     "",True,"FIRST PASS","","See: sys_reason_providence, doc_nature_sanctuaries"),
    ("American Icons","icon_sojourner_truth","Sojourner Truth","Regular",
     "Ain't I a woman? She asked the question that exposed every hypocrite in the room. Truth's patronage uplifts Farms and Temples, and grants Harmony bonuses to provinces with diverse population.\n\nAn Icon. Moves the republic one step toward Reason.",
     "",True,"FIRST PASS","","See: sys_reason_providence, bld_temple, bld_farm"),
    ("American Icons","icon_chief_joseph","Chief Joseph","Regular",
     "I will fight no more forever. Dignity in impossible circumstance. His patronage grants unusual bonuses to Courthouses and morale in occupied territories.\n\nAn Icon. Moves the republic one step toward Reason.",
     "",True,"FIRST PASS","","See: sys_reason_providence"),
    ("American Icons","icon_theodore_roosevelt","Theodore Roosevelt","Regular",
     "BULLY! Busted trusts and invented conservation because he loved shooting things too much to let them go extinct. Roosevelt's patronage boosts Mines, Camps, and Barracks — the great strenuous life.\n\nAn Icon. Moves the republic one step toward Reason.",
     "",True,"FIRST PASS","","See: sys_reason_providence, bld_mine, bld_camp, bld_barracks"),
    ("American Icons","icon_susan_b_anthony","Susan B. Anthony","Regular",
     "Voted illegally in 1872 and turned her trial into a lecture on democracy. Anthony's patronage rewards civic action — Courthouses and Libraries thrive, Mandate generation increases across all provinces.\n\nAn Icon. Moves the republic one step toward Reason.",
     "",True,"FIRST PASS","","See: sys_reason_providence, bld_library"),
    ("American Icons","icon_ida_b_wells","Ida B. Wells","Regular",
     "Documented injustice when no one else would print it. The pen sharper than the sword, and considerably more damning. Wells's patronage powers Libraries.\n\nAn Icon. Moves the republic one step toward Reason.",
     "",True,"FIRST PASS","","See: sys_reason_providence, bld_library"),
    ("American Icons","icon_eleanor_roosevelt","Eleanor Roosevelt","Regular",
     "First Lady, diplomat, UN architect, and the only person FDR was afraid of. Eleanor's patronage rewards empathy in governance — social-tier buildings generate exceptional returns.\n\nAn Icon. Moves the republic one step toward Reason.",
     "",True,"FIRST PASS","","See: sys_reason_providence"),
    ("American Icons","icon_mlk","Martin Luther King Jr.","Regular",
     "The dream is expensive. King's patronage is the most powerful and most demanding — Harmony bonuses across all provinces, but only so long as your laws reflect justice. The moment they don't, expect consequences.\n\nAn Icon. Moves the republic one step toward Reason.",
     "",True,"FIRST PASS","","See: sys_reason_providence"),
    ("American Icons","icon_cesar_chavez","Cesar Chavez","Regular",
     "Si se puede. Chavez organized farm workers when it was genuinely dangerous to do so. His patronage supercharges Farms and grants Manpower bonuses proportional to how many labor laws your nation has passed.\n\nAn Icon. Moves the republic one step toward Reason.",
     "",True,"FIRST PASS","","See: sys_reason_providence, bld_farm"),
    ("American Icons","icon_jimmy_carter","Jimmy Carter","Regular",
     "Brokered peace between Egypt and Israel, then went home and built houses for the poor. Carter's patronage rewards humility — quiet, persistent bonuses to everything, nothing flashy, compounding forever.\n\nAn Icon. Moves the republic one step toward Reason.",
     "",True,"FIRST PASS","","See: sys_reason_providence"),
    ("American Icons","icon_dolores_huerta","Dolores Huerta","Regular",
     "Co-founder of the United Farm Workers and proof that 'no' is not an acceptable final answer. Huerta's patronage amplifies Cesar Chavez's farm bonuses if both are selected, and adds Harmony in provinces with mixed labor.\n\nAn Icon. Moves the republic one step toward Reason.",
     "",True,"FIRST PASS","","See: sys_reason_providence, icon_cesar_chavez, bld_farm"),

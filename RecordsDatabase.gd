...
func _register_all() -> void:
	...
	_add("sys_reason_providence", "Game Systems", "Reason ↔ Providence",
		"The Romantic ↔ Rational axis measures whether your republic leans toward heroic icons (Romantic) or systematic social contracts (Rational). It is tracked as churchLevel, a value from -3 to +3.\n\nchurchLevel = (Social Contracts purchased) − (Romantic Icons purchased), clamped to ±3.\n\nPositive = Rational (more Contracts). Negative = Romantic (more Icons). Zero = Balanced.\n\nCourthouse output per level by axis position:\n  Rational III (+3): +3 Science, +3 Dollars\n  Rational II (+2): +2 Science, +2 Dollars, +1 Mandate\n  Rational I (+1): +1 Science, +1 Dollars, +2 Mandate\n  Balanced (0): +3 Mandate\n  Romantic I (-1): +1 Culture, +50 Manpower, +2 Mandate\n  Romantic II (-2): +2 Culture, +100 Manpower, +1 Mandate\n  Romantic III (-3): +3 Culture, +150 Manpower\n\nThe axis is visible in the Belief Panel. Purchase Social Contracts to move toward Rational; purchase Romantic Icons to move toward Romantic.",
